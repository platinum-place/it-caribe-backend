...
<ul>
    <li>
        <a href="{{ url("cotizaciones/adjuntar/$id") }}" title="Adjuntar" target="__blank">
    ...
    <li>
        <a href="{{ url("cotizaciones/descargar/$id") }}" title="Descargar" target="__blank">
        ...
        <li>
        <a href="{{ url("cotizaciones/condicionado/$plan") }}" title="Condicionado" target="__blank">
