...
<div class="card-group border" style="font-size: small;">
    <div class="card border-0">
        <div class="card-body">
            ...
            <p style="font-size: 15px;">
                <b>PRIMA NETA {{ ($cotizacion->getFieldValue("Plan") == "Mensual Full") ? "MENSUAL" : "ANUAL" }}</b>
                <br>
                <b>ISC</b> <br>
...
<div class="row" style="font-size: 15px;">
    <div class="col-6 border">
        <img src="{{ asset("img/aseguradoras/" . $plan->getFieldValue("Vendor_Name")->getLookupLabel() . ".png") }}"
             width="150" height="50">
