...
namespace Modules\Quote\Vehicle\Application\UseCases;
...
class EstimateQuoteUseCase
{
    ...
    public function handle(
        ...
        foreach ($productsResponse['data'] as $product) {
            ...
            $vendorCRM = $this->zohoApiClient->getRecords('Vendors', $token->accessToken, ['Nombre'], $product['Vendor_Name']['id'])['data'][0];
    ...
    protected function getRate($token, string $productId, float $vehicleAmount, int $vehicleYear, VehicleType $vehicleType): float
    {
