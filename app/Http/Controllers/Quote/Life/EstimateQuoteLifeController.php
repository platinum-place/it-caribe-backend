...
{
    public function __construct(protected EstimateQuoteLifeService $service) {}
     ...
     */
    public function __invoke(EstimateQuoteLifeRequest $request)
    {
        $data = $request->all();
        ...
        $lines = $this->service->handle(
            ...
            $data['PlazoAnios'] * 12,
            $data['MontoOriginal'],
            coBorrowerAge: $data['EdadCodeudor'] ?? null,
        );
