...
<table style="width: 100%; border: none; border-collapse: collapse;">
    ...
    <tr>
        ...
        <td style="border: none; text-align:right;">{{ number_format($selectedLine->total2, 2) }}</td>
        <td style="border: none; text-align:right;">{{ number_format($selectedLine->total1, 2) }}</td>
