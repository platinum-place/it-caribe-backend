...
namespace Modules\Presentation\API\Zoho\Filament\Resources\ZohoOauthAccessTokens;
...
use Modules\Presentation\API\Zoho\Filament\Resources\ZohoOauthAccessTokens\Pages\ManageZohoOauthAccessTokens;
...
class ZohoOauthAccessTokenResource extends Resource
{
    ...
    {
        return [
            'index' => ManageZohoOauthAccessTokens::route('/'),
        ];
    }
