...
use App\Filament\Resources\Vehicles\VehicleResource\Pages;
...
class VehicleResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Resources\VehicleResource\Pages\ListVehicles::route('/'),
            'create' => \App\Filament\Resources\VehicleResource\Pages\CreateVehicle::route('/create'),
            'view' => \App\Filament\Resources\VehicleResource\Pages\ViewVehicle::route('/{record}'),
            'edit' => \App\Filament\Resources\VehicleResource\Pages\EditVehicle::route('/{record}/edit'),
        ];
    }
